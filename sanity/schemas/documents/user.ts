    ...
    fields: [
        ...
        defineField({
          ...
          defineField({
            ...
            options: {
              list: [
                { title: 'Buyer', value: 'buyer', description: 'Individuals or businesses seeking to purchase items or services.' },
                { title: 'Seller', value: 'seller', description: 'Private individuals looking to sell personal items or handcrafted products.' },
                { title: 'Professional Seller/Dealer', value: 'professional_seller', description: 'Businesses or professional sellers offering new or used products, often in specific categories.' },
                { title: 'Service Provider', value: 'service_provider', description: 'Professionals or companies offering services like home repair, tutoring, or event planning.' },
                { title: 'Job Seeker', value: 'job_seeker', description: 'Individuals looking for employment opportunities.' },
                { title: 'Employer/Recruiter', value: 'employer', description: 'Companies or recruiters posting job vacancies.' },
                { title: 'Casual Browser', value: 'casual_browser', description: 'Users who browse classifieds without a specific goal, often for entertainment or curiosity.' },
                { title: 'Community Member', value: 'community_member', description: 'Users participating in community sections of the site, such as forums or groups.' },
                { title: 'Administrator/Moderator', value: 'administrator', description: 'Individuals responsible for overseeing the website\'s operation, including content moderation and user support.' },
                { title: 'Advertiser', value: 'advertiser', description: 'Companies or individuals looking to advertise products or services on the site.' },
              ],
            },
            description: 'The type of user, either Buyer or Advertiser.',
          }),
          defineField({
            name: 'bio',
            title: 'Biography',
