...
import PromotionPaymentSummary from "@/app/(dashboard)/dashboard/post-your-ad/components/PromotionPaymentSummary";
...
const PromoteYourAd = ({ onNext }: Props) => {
  ...
  return (
    <div className={styles.container}>
      ...
      {!isVisible && <div className={styles.paymentSummaryContainer}>
