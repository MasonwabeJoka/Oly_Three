  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          name: 'postListingButton',
          title: 'Post Listing Button',
          type: 'object',
          fields: [
            defineField({
              name: 'showPostListing',
              title: 'Show Post Listing Button',
              type: 'boolean',
              initialValue: true,
            }),
            defineField({
              name: 'postListingText',
              title: 'Post Listing Button Text',
              type: 'string',
              initialValue: 'Post Your Listing',
              hidden: ({ parent }) => !parent?.showPostListing,
            }),
            defineField({
              name: 'postListingUrl',
              title: 'Post Listing URL',
              type: 'string',
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          ...
          type: 'boolean',
          initialValue: true,
          description: 'Track login, register, and post listing button clicks.',
        }),
      ],
