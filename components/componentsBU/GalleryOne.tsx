...
const GalleryOne = ({ images, onClick }: ImageGroup) => {
  ...
  const portraitImages = (images: Image[]) => {
  ...
  const numberOfPortraitImages = images ? portraitImages(images) : 3;
    ...
    <div className={styles.container}>
      ...
      >
        <div
          ...
          onMouseLeave={() => setIsCardHovered(false)}
          style={
            images && galleryStyles(images?.length, 0, images[0].aspectRatio)
          }
        >
          <div
        ...
        {images && images.length > 1 && (
          <div
            ...
            style={{
              flexDirection:
                images && images.length === 3 && images[2].aspectRatio > 1
                  ? "column"
                  : "row",
              rowGap: "0.75rem",
              flexWrap: "wrap",
          ...
          >
            <div
              ...
              style={
                images &&
                images[1] &&
                galleryStyles(images?.length, 1, images[1].aspectRatio)
              }
            >
              <div
                style={{ position: "relative", width: "100%", height: "100%" }}
            ...
            <div
              ...
              style={
                images &&
                images[2] &&
                galleryStyles(images?.length, 2, images[2].aspectRatio)
              }
            >
              <div
                style={{ position: "relative", width: "100%", height: "100%" }}
            ...
            <div
              ...
              style={
                images &&
                images[3] &&
                galleryStyles(images?.length, 3, images[3].aspectRatio)
              }
            >
              <div
                style={{ position: "relative", width: "100%", height: "100%" }}
            ...
            <div
              ...
              style={
                images &&
                images[4] &&
                galleryStyles(images?.length, 4, images[4].aspectRatio)
              }
            >
              <div
                style={{ position: "relative", width: "100%", height: "100%" }}
